...
let mkArgs =
    ...
    UnixSocketsFolderPath = "./tests-sockets/local"
                ...
                new INetworkProvider with
                    member this.RemoteListener = {
                        new INetworkListener with
                            ...
                            member this.Bind() = UnixSocket.tryBindTo "./tests-sockets/remote/remote.socket" DefaultSockets.remoteListener
                            member this.GenerateClient _ = UnixSocket.client
                            member this.Connect _ socket = UnixSocket.connectSocket socket "./tests-sockets/remote/remote.socket"}
                    member this.LocalListener = {
                        new INetworkListener with
                            ...
                            member this.Bind() = UnixSocket.tryBindTo "./tests-sockets/local/local.socket" DefaultSockets.localListener
                            member this.GenerateClient _ = UnixSocket.client
                            member this.Connect _ socket = UnixSocket.connectSocket socket "./tests-sockets/local/local.socket"
                    }
    } 
}